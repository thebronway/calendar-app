...
### Release v1.1.3: Theming Updates
...
- Identify additional elements for theming (look at what is already done for custom as a start)
  - once we id what areas need custom theming, we will wire them up one by one. and test. and make sure dark mode/ light mode are affected. Only one thing at a time. So we'll look at for example the month view and we'll just change the background of the month view. We will test it. We'll see how it looks and then we'll validate or revert. One element at a time. Slow and steady here.

### Release v1.1.4: Multi-Year iCal Sync Engine
...
### Release v1.1.6: Enterprise Single Sign-On (SSO / OIDC)
...
### Release v1.1.7: API Keys & REST API
...
### Release v1.1.8: PTO & Vacation Tracker Dashboard
