...
const BulkEditBar: React.FC<BulkEditBarProps> = ({ selectedCells, onEditSelected, onClear, onCancel }) => {
  return (
    <div className="fixed bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 px-4 py-3 sm:p-4 rounded-xl shadow-2xl border-2 border-theme-accent-secondary dark:border-theme-accent-secondary z-40 flex items-center justify-between gap-4 w-[90%] sm:w-auto min-w-[280px]">
