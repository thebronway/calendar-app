          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border dark:border-gray-700">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-gray-100 dark:bg-gray-900 border dark:border-gray-700 rounded-lg flex flex-col items-center justify-center text-center">
                <span className="text-xs font-bold text-gray-500 uppercase mb-2 tracking-wider">
                  Live Preview
                </span>
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-gray-200 dark:bg-black rounded-lg border dark:border-gray-700">
                <span className="block text-xs font-bold text-gray-500 uppercase mb-2 tracking-wider text-center">
                  Browser Tab Preview
                </span>
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-75 z-50 flex items-center justify-center p-4">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <ToggleSwitch
                        ...
                        onChange={(val) => handleUpdateItem(cat.id, 'showCount', val)}
                      />
                    </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 border-l pl-4 dark:border-gray-700">
                        ...
                        <ToggleSwitch
                          ...
                          onChange={(val) => handleUpdateItem(item.id, 'showCount', val)}
                        />
                      </div>
                      <div className="flex items-center space-x-1 border-l pl-2 dark:border-gray-700">
                        <button
      ...
      <IconEditor
        ...
        initialIconData={editingIconId ? localKeyItems.find((i) => i.id === editingIconId) : null}
      />
    </div>
  );
};
                ...
                {localLocations && localLocations.length > 0 ? (
                  localLocations
                    ...
                    .map((location, index) => (
                      <span
                        key={index}
                        className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm font-medium text-gray-800 dark:text-gray-200 break-all"
                      >
                        {location}
                      </span>
                    ))
                ...
                <div className="space-y-2">
                  {localIcons.map((item, index) => {
                    ...
                    if (iconValue !== 'None' && ICON_MAP[iconValue]) {
                      ...
                      const keyItem = keyItems.find(
                        (k) => k.icon === iconValue && k.iconColor === item.color
                      );
                      return (
                        <div
                          key={index}
                          className="flex items-center space-x-3 p-2 border dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-700"
                        >
              ...
              {activeTab === 'category' && (
                <div className="space-y-4">
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                    Select a category for this day:
                  </p>
                  ...
                  <div className="space-y-2">
                    ...
                    {localIcons.map((item, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className="flex items-center justify-between p-2 border dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800"
                        >
      ...
      <div key={mName} id={`month-${mIdx}`} className="w-full md:w-1/2 2xl:w-1/3 p-2">
        ...
        >
          ...
          <span className="text-sm font-normal bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-1 rounded-full">
            ...
            {Math.round((monthHighCount / daysInMonth) * 100)}%)
          </span>
        </div>
